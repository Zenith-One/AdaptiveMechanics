...
public class BlockMechanicalReceiver extends BlockAdaptiveMachine {
   ...
   @Override
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer player, int par6, float par7, float par8, float par9) {
        TileEntityMechanicalReceiver tileEntityMechanicalReceiver = (TileEntityMechanicalReceiver) par1World.getTileEntity(par2, par3, par4);

        if (tileEntityMechanicalReceiver.getWorldObj().isRemote){
            System.out.println("Receiver meta: " + tileEntityMechanicalReceiver.getBlockMetadata());
        }
